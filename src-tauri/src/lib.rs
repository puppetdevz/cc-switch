...
pub fn run() {
    ...
    let builder = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::cloud_sync_get_selection,
            commands::cloud_sync_set_selection,
            commands::cloud_sync_get_category_stats,
            commands::cloud_sync_init_category,
            commands::cloud_sync_delete_categories,
            commands::cloud_sync_delete_v2_snapshot,
            commands::cloud_sync_retry_cleanup,
            commands::cloud_sync_remote_inventory,
